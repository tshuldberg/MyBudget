 ...
 *
 * @param amountCents - Source amount in cents
 * @param rate - Exchange rate as integer (rate * 1_000_000)
 ...
 * @param currencies - Available currency definitions
 * @returns Formatted string (e.g. "$12.50", "JPY 1250")
 */
 ...
 * @param rates - Available exchange rates
 * @returns Converted amount in base currency cents
...
export function convertToBase(
  ...
  if (inverse) {
    ...
    // amountCents * (RATE_PRECISION / inverse.rate)
